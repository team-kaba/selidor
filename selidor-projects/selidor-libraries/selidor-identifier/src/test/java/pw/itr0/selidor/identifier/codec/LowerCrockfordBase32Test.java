...
class LowerCrockfordBase32Test {
  ...
  static Iterable<Arguments> base32EncodeBytesToStringMapping() {
    return List.of(
        ...
        arguments(new byte[] {0b00101_000}, "50"),
        arguments(new byte[] {0b00110_000}, "60"),
        arguments(new byte[] {0b00111_000}, "70"),
        arguments(new byte[] {0b01000_000}, "80"),
        arguments(new byte[] {0b01001_000}, "90"),
        arguments(new byte[] {0b01010_000}, "a0"),
        arguments(new byte[] {0b01011_000}, "b0"),
        arguments(new byte[] {0b01100_000}, "c0"),
        arguments(new byte[] {0b01101_000}, "d0"),
        arguments(new byte[] {0b01110_000}, "e0"),
        arguments(new byte[] {0b01111_000}, "f0"),
        arguments(new byte[] {(byte) 0b10000_000}, "g0"),
        arguments(new byte[] {(byte) 0b10001_000}, "h0"),
        arguments(new byte[] {(byte) 0b10010_000}, "j0"),
        arguments(new byte[] {(byte) 0b10011_000}, "k0"),
        arguments(new byte[] {(byte) 0b10100_000}, "m0"),
        arguments(new byte[] {(byte) 0b10101_000}, "n0"),
        arguments(new byte[] {(byte) 0b10110_000}, "p0"),
        arguments(new byte[] {(byte) 0b10111_000}, "q0"),
        arguments(new byte[] {(byte) 0b11000_000}, "r0"),
        arguments(new byte[] {(byte) 0b11001_000}, "s0"),
        arguments(new byte[] {(byte) 0b11010_000}, "t0"),
        arguments(new byte[] {(byte) 0b11011_000}, "v0"),
        arguments(new byte[] {(byte) 0b11100_000}, "w0"),
        arguments(new byte[] {(byte) 0b11101_000}, "x0"),
        arguments(new byte[] {(byte) 0b11110_000}, "y0"),
        arguments(new byte[] {(byte) 0b11110_000}, "y0"),
        arguments(new byte[] {(byte) 0b11111_000}, "z0"),
